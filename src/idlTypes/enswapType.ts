 ...
 * IDL can be found at `target/idl/enswap_amm.json`.
 */
export type EnswapAmm = {
  "address": "F4dfAy46FYa11G28VkreEirfqdfPw3ptgmd8rwQffsYS",
  "metadata": {
    "name": "enswapAmm",
    "version": "0.1.0",
    "spec": "0.1.0",
  ...
  "instructions": [
    ...
    },
    {
      ...
      "accounts": [
        ...
        {
          "name": "tokenReserveSrc",
          "writable": true
        },
        {
          "name": "tokenReserveDst",
          "writable": true
        },
        {
          "name": "userSrcTokenAcc",
          "writable": true
        },
        {
          "name": "userDstTokenAcc",
          "writable": true
        },
        {
          "name": "poolAuthority",
  ...
  "errors": [
    ...
    {
      "code": 6004,
      "name": "insufficientTotalMintSupply",
