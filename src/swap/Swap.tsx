      ...
      <div className="w-full sm:w-1/2">
        ...
        <div className="glass rounded-3xl p-4 space-y-2">
          ...
          {fromAmount && swapQuote.isValid && (
            <div className="glass-light rounded-2xl p-3 space-y-2 mt-3">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className={swapQuote.priceImpact > 5 ? "text-red-400" : "text-emerald-400"}>
                  {swapQuote.priceImpact < 0.01 ? "<0.01%" : `${swapQuote.priceImpact.toFixed(2)}%`}
                </span>
              </div>
              <div className="flex items-center justify-between text-sm">
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-muted-foreground">Fee ({slippage}% slippage)</span>
                <span className="text-foreground">{swapQuote.fee?.toFixed(6) || '0'} {fromToken.symbol}</span>
              </div>
            </div>
          )}
          ...
          <Button
            ...
            onClick={swap}
          >
            {isPending ? "Swapping..." : !fromAmount ? "Enter an amount" : "Swap"}
          </Button>
        </div>
      </div>
